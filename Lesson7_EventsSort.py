...
"""For each visitor we know TimeIn, TimeOut. We suppose that visitor was at the web-site from TimeIn till TimePut inclusively"""
...
"""Web-site was visited by N-number of visitors"""
"""For each visitor we know TimeIn, TimeOut. We suppose that visitor was at the web-site from TimeIn till TimePut inclusively"""
"""We should define time interval that at least one visitor were online"""

"""Solution"""
"""If we came to the event with a positive counter of people number,than there was someone online before current event and previous one"""
...
"""Web-site was visited by N-number of visitors"""
"""For each visitor we know TimeIn, TimeOut. We suppose that visitor was at the web-site from TimeIn till TimePut inclusively"""
"""Chief visited the web-site M-times, at time-moments Boss and watched how many people were online. Chief visits are sorted by time"""
"""We should define which values of the counter of people online he saw."""

"""Solution"""
"""Lets create a new event - entrance of the Chief and if this event happens we will save a current number of visitors online"""
